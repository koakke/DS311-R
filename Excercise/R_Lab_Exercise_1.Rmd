...
```{r}
# Enter your code here.
alphabet.lower=letters
alphabet.upper=matrix(data=LETTERS,byrow=TRUE,nrow=2)
alphabet.lower
alphabet.upper
...
wd2<-setwd("C:/Users/nqhun/DS311/R")
...
install.packages("MASS",repos="http://cran.us.r-project.org",INSTALL_opts = '--no-lock')

# Install multiple packages at once
install.packages(c("dplyr", "ggplot2"),repos="http://cran.us.r-project.org")
